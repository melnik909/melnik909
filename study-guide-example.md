...
Этот гайд ответит тебе на вопрос: "Для чего используют `aria-hidden`? Как его лучше использовать?". Как я понял из личного общения у тебя есть опыт верстки, и ты уже многое знаешь о цифровой доступности. Можешь протестировать интерфейс при помощи скринридера. При написании гайда я это учел. 

В нем я расскажу тебе про практические кейсы и нюансы, которые важно знать при работе с атрибутом. Надеюсь тебе будет интересно, и на все свои вопросы ты найдешь ответ. Но, если возникнут новые, напиши мне. Мы вместе все разберем.
