...
Этот гайд ответит тебе на вопрос: "Для чего используют `aria-hidden`? Как его лучше использовать?". Как я понял из личного общения у тебя есть опыт верстки, и ты уже многое знаешь о цифровой доступности. При написании гайда я это учел. 
